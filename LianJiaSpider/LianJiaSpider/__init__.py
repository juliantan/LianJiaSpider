...
if status == 0:
	cursor.execute("CREATE DATABASE {0};use {0};CREATE TABLE {1}(ID INT PRIMARY KEY,area VARCHAR(200),loupanName VARCHAR(200),address VARCHAR(200),doorModel VARCHAR(200),state VARCHAR(200),houseType VARCHAR(200),price VARCHAR(200),loupanurl VARCHAR(200));".format(dbName,tableName))
else:
